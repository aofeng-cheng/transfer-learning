...
def load_data():
    imgs = {'tiger': [], 'password': []}
    for k in imgs.keys():
        dir = 'E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/data/' + k
    ...
    cat_y = np.maximum(10, np.random.randn(len(imgs['password']), 1) * 8 + 40)
    print(len(imgs['tiger']))
    print(tigers_y)
    print(len(imgs['password']))
    print(cat_y)
    return imgs['tiger'], imgs['password'], tigers_y, cat_y
...
class Vgg16:
    ...
    def save(self, path='E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/model/transfer_learn'):
        saver = tf.train.Saver()
...
def train():
    ...
    plt.hist(tigers_y, bins=20, label='tiger')
    plt.hist(cats_y, bins=10, label='password')
    plt.legend()
    plt.xlabel('length')
    plt.show()
    ...
    vgg = Vgg16(vgg16_npy_path='E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/vgg16.npy')
    print('Net built')
    for i in range(100):
    ...
    vgg.save('E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/model/transfer_learn')      # save learned fc layers


def eval():
    vgg = Vgg16(vgg16_npy_path='E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/vgg16.npy',
                restore_from='E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/model/transfer_learn')
    vgg.predict(
        ['E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/data/password/2.jpg',
         'E:/notebook/Tensorflow-Tutorial-master/tutorial-contents/for_transfer_learning/data/tiger/test.jpg'])
